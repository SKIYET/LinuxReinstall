...
[[ -z "$myPASSWORD" ]] && myPASSWORD='$1$kO/pO5ZR$ImxeyVACedQstnEj7wNu2/';
...
d-i netcfg/get_nameservers string TargetNS
...
########################### Only One Partition(No Swap Partition)########  
d-i partman-auto/expert_recipe string \
    boot-root :: \
        500 10000 -1 TargetFS  \
        $primary{ } $bootable{ } \
        method{ format } format{ } \
        use_filesystem{ } filesystem{ TargetFS } \
        mountpoint{ / } \
                  .                   
